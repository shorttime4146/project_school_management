                ...
                <!--begin::Container-->
                    <div class="container-fluid">
                        <!--begin::Row-->
                            <div class="row">
                                <div class="col-sm-6">
                                    <h3 class="mb-0">Teacher Tables</h3>
                                </div>
                                <div class="col-sm-6">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="100px" align="center">                
                                                                <a href="teacher_update_form.php?up_id=<?php echo $row['id']; ?>">Update</a>
                                                            </td>
                                                            <td width="100px" align="center">
                                                                <a href="teacher_delete_controller.php?del_id=<?php echo $row['id']; ?>">Delete</a>
                                                            </td>
                                                        </tr>
                                                        <?php 
                                                            }
