        ...
        <!--begin::Container-->
          <div class="container-fluid">
            <!--begin::Row-->
              <div class="row">
                <div class="col-sm-6">
                  <h3 class="mb-0">Subject Form</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Subject Form</li>
                    </ol>
                </div>
              </div>
            <!--end::Row-->
                      ...
                      <div class="card card-info card-outline mb-4">
                        <!--begin::Header-->
                          <div class="card-header">
                            <div class="card-title">Subject Update Form</div>
                          </div>
                        <!--end::Header-->
                        <!--begin::Form-->
                          <form class="needs-validation" novalidate action="sub_update_controller.php" method="post">
                            <!--begin::Body-->
                              <div class="card-body">
                                <!--begin::Row-->
                                  <div class="row g-3">
                                    ...
                                    <!--begin::Col-->
                                      <div class="col-md-6">
                                        <label for="validationCustom02" class="form-label">Subject Code</label>
                                        <input
                                          type="number"
                                          name="sub_code"
                                          class="form-control"
                                      ...
                                      <div class="col-md-6">
                                        <label for="validationCustom01" class="form-label">Subject Type:</label>
                                          ...
                                          <select name="type_id">
                                            ...
                                            <?php 
                                              foreach($sub_arr as $type_id=>$val){                                                                
                                            ?>                                                            
                                            <option value="<?php echo $type_id; ?>"><?php echo $val; ?></option>
                                            <?php 
                                              } 
                                            ?>
                                          </select>
